              ...
              "content": [
                {
                  "type": "text",
                  "text":
                      "GPT, il tuo compito è quello di generare fino ad un massimo di 5 ricette usando la funzione createRecipesObject. Devi farlo usando in parte o anche tutta questa lista di ingredienti: $ingredients. Rispondi precisamente con il nome della ricetta, la lista degli ingredienti, una categoria sensata per il tipo di ricetta, un tempo approssimativo di preparazione, un breve riassunto generale di quello che sarà il piatto, ed infine le istruzioni numerate, passaggio per passaggio, per eseguire la preparazione della ricetta. Se necessario, sii esaustivo su come eseguire la preparazione del piatto. Rispondi sempre in Italiano.",
                }
              ],
            },
          ],
